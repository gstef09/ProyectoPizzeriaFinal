...
private void SeleccionaCliente(){
     ...
     String nombre=Tabla_datos.getValueAt(row, 1).toString();
     String apellido=Tabla_datos.getValueAt(row, 2).toString();
     String cedula=Tabla_datos.getValueAt(row, 5).toString();
     String direccion=Tabla_datos.getValueAt(row, 7).toString();
     InterfazFactura.txtCod.setText(id);
     InterfazFactura.txtNombre.setText(nombre+ " " + apellido);
     InterfazFactura.txtCed.setText(cedula);
     InterfazFactura.txtDir.setText(direccion);
     this.dispose();
    }
