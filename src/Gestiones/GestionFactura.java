    ...
    public void Insertar() throws SQLException {
        try {
          ...
          for (Detalle_Factura detFact:factura.getDetalle()){
              Conexionbd.getInstancia().ejecutar("insert into Detalle_Factura (Codigo_Detalle,N_Factura,Codigo_Producto,Nombre_Producto,Cantidad,Precio_Unitario,Precio_Venta)"
